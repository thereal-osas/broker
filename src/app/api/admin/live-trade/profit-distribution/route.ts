...
export async function POST() {
  try {
    ...
    console.log(`Admin ${session.user.email} initiated live trade profit distribution...`);
    ...
    console.log(`Live trade profit distribution completed by admin ${session.user.email}:`, {
